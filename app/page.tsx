...
export default function Home(){
 ...
 return <main className="explorer">
  <header className="masthead"><div className="brand"><Network size={24}/><div><h1>Connect the Dots</h1><span>AI safety · funding · institutions · policy</span></div></div><div className="dateline"><span className="live-dot"/>Evidence through {raw.as_of}</div><a className="repository-link" href="https://github.com/sploithunter/connect-the-dots" target="_blank" rel="noopener noreferrer" aria-label="GitHub repository (opens in a new tab)">GitHub ↗</a><Button variant="outline" onClick={exportSvg}><Download/>Export graph</Button></header>
  <div className="workspace">
   ...
   <aside className="inspector" aria-live="polite">
    ...
    <footer>Public-source investigation<br/>{raw.nodes.length} nodes · {raw.edges.length} relationship records<br/><a href="https://github.com/sploithunter/connect-the-dots/blob/main/wiki/index.md" target="_blank" rel="noopener noreferrer">Research & contributor wiki ↗</a><br/><a href="https://github.com/sploithunter/connect-the-dots/issues/new?template=evidence.yml" target="_blank" rel="noopener noreferrer" aria-label="Submit evidence (opens in a new tab)">Submit evidence ↗</a></footer>
   </aside>
  </div>
 </main>;
}
