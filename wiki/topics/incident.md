...
The graph adds a **Coxon-window Congress** view for this cluster. What would tighten it: original status IDs for HuffPost-quoted posts that still lack URLs, and primary text for any Luna–Khanna joint framework.
